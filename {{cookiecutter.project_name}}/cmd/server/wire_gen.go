...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	{{cookiecutter.repo_name}}Repo := data.New{{cookiecutter.repo_service_name}}Repo(dataData, logger)
	{{cookiecutter.repo_name}}Usecase := biz.New{{cookiecutter.repo_service_name}}Usecase({{cookiecutter.repo_name}}Repo, logger)
	{{cookiecutter.repo_name}}Service := service.New{{cookiecutter.repo_service_name}}Service({{cookiecutter.repo_name}}Usecase)
